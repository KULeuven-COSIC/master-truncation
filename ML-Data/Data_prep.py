...
def main():
	...
	WriteFile('weights0.txt', 0)
	WriteFile('weights1.txt', 0)
	WriteFile('weights2.txt', 0)
	WriteFile('weights3.txt', 0)
	WriteFile('weights4.txt', 0)
	WriteFile('biases0.txt', 1)
	WriteFile('biases1.txt', 1)
	WriteFile('biases2.txt', 1)
	WriteFile('biases3.txt', 1)
	WriteFile('biases4.txt', 1)
